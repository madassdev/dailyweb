                    ...
                    <div className="space-y-8">
                        <div className="">
                            ...
                            <p className="text-xs text-gray-400 text-light">
                                ...
                                adipisicing elit. Aperiam dolorum rem expedita
                                itaque et nihil.
                            </p>
                        </div>
                    ...
                    <div className="w-1/2 space-y-8">
                        <div className="space-y-1">
                            ...
                            <p className="text-xs text-light text-gray-600">
                                Lorem ipsum dolor, sit amet consectetur
                                adipisicing elit. Ipsam cupiditate architecto,
                                numquam praesentium ea non dignissimos quas
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p className="text-xs font-light text-gray-600">
                                Lorem ipsum dolor sit amet consectetur
                                adipisicing elit. Tempora similique explicabo,
                                molestias maiores cumque, laudantium excepturi
                            </p>
                        </div>
